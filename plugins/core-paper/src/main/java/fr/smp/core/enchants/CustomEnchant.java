...
public enum CustomEnchant {
    ...
    UNB_V  ("solidite_5",   "Solidité",        5, Flavour.OVERCAP, Target.BREAKABLE,  Enchantment.UNBREAKING,
            "<gray>Durabilité absolue. Niveau V.</gray>"),
    PROT_V ("protection_5", "Protection",      5, Flavour.OVERCAP, Target.ARMOR,      Enchantment.PROTECTION,
            "<gray>Réduction de dégâts élevée. Niveau V.</gray>"),
    PROT_VI("protection_6", "Protection",      6, Flavour.OVERCAP, Target.ARMOR,      Enchantment.PROTECTION,
            "<gray>Réduction de dégâts absolue. Niveau VI.</gray>"),
